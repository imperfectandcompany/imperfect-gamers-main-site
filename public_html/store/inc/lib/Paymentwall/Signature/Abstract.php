...
abstract class Paymentwall_Signature_Abstract extends Paymentwall_Instance
{
    ...
    abstract public function process($params = array(), $version = 0);

    abstract public function prepareParams($params = array(), $baseString = '');

    final public function calculate($params = array(), $version = 0)
    {
