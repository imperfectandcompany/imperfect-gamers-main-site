    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-md-6" style="text-align: right;">
          ...
          <?php } ?>
          <i class="fab fa-steam"></i> <?= lang('powered_by', 'Powered By'); ?> <a href="http://steampowered.com">Steam</a><br>
...
<script src="<?= global_theme_path() . '/js/scripts.js?version=' . version_hash() ?>"></script>

<script src="<?= current_theme_path() . '/js/scripts.js?version=' . version_hash() ?>"></script>

<script>
  var backgrounds = {};
  backgrounds.duration = <?= config()->get('main.backstretch.duration') * 1000; ?>;
  backgrounds.fade = <?= config()->get('main.backstretch.fade') * 1000; ?>;
  backgrounds.random = <?= config()->get('main.backstretch.random'); ?>;
  backgrounds.list = [<?= "'" . implode("','", config()->get('main.backstretch.backgrounds')) . "'"; ?>];
</script>
