...
$db->execute("CREATE TABLE IF NOT EXISTS packages (
		...
		expire_linked varchar(1024) DEFAULT '[]',
...
$db->execute("INSERT INTO settings (name, value, value2, value3) VALUES
		...
		('advent_claim_current_day_only', NULL, 0, NULL),
		('store_disable_read_more', NULL, 0, NULL)
	");
...
$db->execute(
    "INSERT INTO permission_groups SET title = ?, json = ?",
    array('root', '["all"]')
);
...
$db->execute("CREATE TABLE advent_calendar (
	...
	img TEXT NULL,
	package TEXT NULL,
	credits int DEFAULT null NULL,
	random tinyint NULL DEFAULT NULL,
	PRIMARY KEY (day)
	)
	DEFAULT CHARACTER SET utf8mb4   
	COLLATE utf8mb4_general_ci
