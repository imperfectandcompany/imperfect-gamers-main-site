<head>
    ...
    <meta name="description"
        content="Imperfect Gamers is an entertainment organization focused on promoting growth in underground music.">
    ...
    <link rel="stylesheet" href="<?php echo $GLOBALS['config']['url']; ?>/css/main.css">
</head>
