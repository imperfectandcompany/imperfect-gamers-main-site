    ...
    <section class="animate__animated animate__fadeIn">
        ...
        <div class="bg-black/30 p-8 rounded-lg">
            ...
            <div
                ...
                <h2 class="text-3xl font-bold mb-4">Personal Identification Information</h2>
                <p>We collect personal identification information from Users in a variety of ways, including, but
                    not limited to, when Users visit our site, register on the site, place an order, and in
                    connection with other activities, services, features or resources we make available on our Site.
                    Users may visit our Site anonymously. We will collect personal identification information from
...
<div
    ...
    <p>We partner with Microsoft Clarity and Google Analytics to capture how you use and interact with our website through behavioral metrics, heatmaps, and session replay to improve and market our products/services. Website usage data is captured using first and third-party cookies and other tracking technologies to determine the popularity of products/services and online activity. Additionally, we use this information for site optimization, fraud/security purposes, and advertising. For more information about how Microsoft and Google collect and use your data, visit the Microsoft Privacy Statement and Google Privacy & Terms.</p>
            ...
            <div
                class="mb-12 card flex flex-col justify-between rounded-lg p-6 bg-red-900/10 border-red-600/50 text-white">
                <h2 class="text-3xl font-bold mb-4">Web Browser Cookies</h2>
                <p>Our Site may use "cookies" to enhance User experience. Users' web browser places cookies on their
            ...
            <div
                class="mb-12 card flex flex-col justify-between rounded-lg p-6 bg-red-900/10 border-red-600/50 text-white">
                <h2 class="text-3xl font-bold mb-4">How We Use Collected Information</h2>
                <p>Imperfect Gamers may collect and use Users personal information for the following purposes:</p>
                <ul class="list-disc pl-6">
                    <li>To process payments: We may use the information Users provide about themselves when placing
                        an order only to provide service to that order. We do not share this information with
                        outside parties except to the extent necessary to provide the service.</li>
                </ul>
            </div>
            <!-- Sharing Your Personal Information Section -->
            <div
                class="mb-12 card flex flex-col justify-between rounded-lg p-6 bg-red-900/10 border-red-600/50 text-white">
                <h2 class="text-3xl font-bold mb-4">Sharing Your Personal Information</h2>
            ...
            <div
                class="mb-12 card flex flex-col justify-between rounded-lg p-6 bg-red-900/10 border-red-600/50 text-white">
                <h2 class="text-3xl font-bold mb-4">Your Acceptance Of These Terms</h2>
                <p>By using this Site you signify your acceptance of this policy. If you do not agree
                    to this policy, please do not use our Site. Your continued use of the Site following the posting
        ...
        <div class="text-sm mt-4">
            <p>If you have any questions about this Privacy Policy, the practices of this site, or your dealings
                with this site, please contact us at: policies@imperfectgamers.org</p>
        </div>
    </section>
</div>
