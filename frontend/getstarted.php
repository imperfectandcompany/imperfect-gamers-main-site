    ...
    <div class="container">
        <div class="flex flex-col mt-20 fullscreen justify-content-center align-items-center">
            <div class="mb-8 mt-4 text-center animate__animated animate__fadeIn animate__delay-1s ">
                <h1 class="text-white text-6xl font-bold"><?php echo (!isset($success)) ? "Pick a username" : htmlspecialchars($username, ENT_QUOTES) . " is a good name!";?><br /></h1>
                <div class="">
                ...
                <form method="POST">
                    <div class="flex flex-col space-y-8">
                        <div class="selection:bg-red-300 selection:text-red-900">
                            ...
                            <input type="username" tabindex="1" id="username" name="username" value="<?php echo htmlspecialchars($username, ENT_QUOTES); ?>" class="
