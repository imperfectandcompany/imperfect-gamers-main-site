   ...
   <div class="container">
      <div class="flex flex-col mt-40 fullscreen justify-content-center align-items-center">
         ...
         <div class="banner-content text-center">
            ...
            <a href="https://prototype.imperfectgamers.org/<?php if ($loggedIn): ?>
logout
<?php else: ?>
login
<?php endif; ?>" class="primary-btn banner-btn animate__animated animate__fadeInUp">
            ...
            <a href="https://prototype.imperfectgamers.org/applications"
               class="primary-btn banner-btn animate__animated animate__fadeInUp">
               Applications
            </a>
            ...
            <div id="server" class="container hidden">
               <div class="flex justify-center items-center">
                  <div class="flex flex-col">
                     <h2 class="text-4xl md:text-5xl font-medium tracking-tight text-center leading-tight text-white">
                        Our Servers</h2>
                           ...
                           <div class="md:hidden w-80 rounded-xl shadow-lg"
                              ...
                              <div class="flex items-center justify-between">
                                 <div class="flex">
                                    <img class="block mr-2 w-12 h-12"
                                       src="https://i.ytimg.com/vi/YJ8OypG2vjA/maxresdefault.jpg" alt="cs2">
                                    <div>
                              ...
                              <div class="flex flex-col pt-4">
                                 <div class="outline outline-1 rounded-xl outline-white overflow-hidden">
                                    <img class="rounded-xl" src="https://i.ytimg.com/vi/YJ8OypG2vjA/maxresdefault.jpg"
                                       alt="map">
                                 </div>
                              </div>
                           </div>
                           <div
                              class="hidden md:block w[33.5rem] h[37rem] max-w-[33.5rem] p-6 rounded-xl shadow-lg mx-2"
                              style="background-color: rgba(27, 27, 27, 0.66); backdrop-filter: blur(10px);">
                              <div class="flex items-center justify-between">
                                 <div class="flex">
                                    <img class="block mr-2 w-12 h-12"
